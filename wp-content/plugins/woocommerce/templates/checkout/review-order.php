...
<div id="order_review">
	...
	<table class="shop_table">
		<thead>
			<tr>
				<th class="product-name"><?php _e( 'Позиція', 'woocommerce' ); ?></th>
				<th class="product-total"><?php _e( 'Ціна', 'woocommerce' ); ?></th>
			</tr>
		</thead>
		<tfoot>
	...
	<div id="payment">
		...
		<div class="form-row place-order">
			...
			echo apply_filters( 'woocommerce_order_button_html', '<input type="submit" class="button alt" name="woocommerce_checkout_place_order" id="place_order" value="Замовити" data-value="' . esc_attr( $order_button_text ) . '" />' );
			?>
